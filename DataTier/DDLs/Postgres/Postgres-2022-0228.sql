...
CREATE TABLE impl_codesetstoapplication (
                                            ...
                                            formalname varchar(45) DEFAULT 'NULL'::character varying,
                                            address varchar(45) DEFAULT 'NULL'::character varying,
                                            citystatezip varchar(99) DEFAULT 'NULL'::character varying,
                                            phonenumber varchar(20) DEFAULT 'NULL'::character varying,
                                            otherfield1 varchar(49) DEFAULT 'NULL'::character varying,
                                            otherfield2 varchar(49) DEFAULT 'NULL'::character varying,
                                            termlow varchar(25) DEFAULT 'NULL'::character varying,
                                            termhigh varchar(25) DEFAULT 'NULL'::character varying,
...
CREATE TABLE impl_codesetstomsgtype (
                                        ...
                                        codesetsid bigint,
                                        msgtype varchar(75) DEFAULT 'NULL'::character varying,
                                        statusid integer DEFAULT 1,
                                        createddate timestamp DEFAULT CURRENT_TIMESTAMP,
                                        createduser varchar(20) DEFAULT 'NULL'::character varying,
                                        appguid char(38) DEFAULT 'NULL'::bpchar,
                                        orgguid char(38) DEFAULT 'NULL'::bpchar,
...
CREATE UNIQUE INDEX dataexisting_ababanking_pkey ON dataexisting_ababanking USING btree (ababankingid);

CREATE UNIQUE INDEX dataexisting_areacode_pkey ON dataexisting_areacode USING btree (areacodeid);

CREATE UNIQUE INDEX dataexisting_areacodeintl_pkey ON dataexisting_areacodeintl USING btree (iddcode);

CREATE UNIQUE INDEX dataexisting_companies_pkey ON dataexisting_companies USING btree (companiesid);
...
CREATE UNIQUE INDEX dataexisting_namefirst_pkey ON dataexisting_namefirst USING btree (firstnameid);
...
CREATE UNIQUE INDEX dataexisting_namelast_pkey ON dataexisting_namelast USING btree (lastnameid);

CREATE UNIQUE INDEX dataexisting_namelast_uindex ON dataexisting_namelast USING btree (lastname, registeredapp);

CREATE UNIQUE INDEX dataexisting_upccodes_pkey ON dataexisting_upccodes USING btree (upccodeid);

CREATE UNIQUE INDEX dataexisting_zipcodeintl_pkey ON dataexisting_zipcodeintl USING btree (zipcodeintnlid);

CREATE UNIQUE INDEX dataexisting_zipcodeus_pkey ON dataexisting_zipcodeus USING btree (zipcodeid);
...
CREATE UNIQUE INDEX datagenerated_accountnumbers_pkey ON datagenerated_accountnumbers USING btree (accountnumbersid);
...
CREATE UNIQUE INDEX datagenerated_addresses_pkey ON datagenerated_addresses USING btree (addressid);
...
CREATE UNIQUE INDEX datagenerated_bankaccount_pkey ON datagenerated_bankaccount USING btree (bankaccountsid);
...
CREATE UNIQUE INDEX datagenerated_creditcard_pkey ON datagenerated_creditcard USING btree (creditcardid);
...
CREATE UNIQUE INDEX datagenerated_dateofbirth_pkey ON datagenerated_dateofbirth USING btree (dateofbirthsid);
...
CREATE UNIQUE INDEX datagenerated_driverslicenses_pkey ON datagenerated_driverslicenses USING btree (driverslicensesid);
...
CREATE UNIQUE INDEX datagenerated_ein_pkey ON datagenerated_ein USING btree (einid);
...
CREATE UNIQUE INDEX datagenerated_phonenumber_pkey ON datagenerated_phonenumber USING btree (phonenumberid);
...
CREATE UNIQUE INDEX datagenerated_phonenumbersintl_pkey ON datagenerated_phonenumbersintl USING btree (phonenumberintlid);
...
CREATE UNIQUE INDEX datagenerated_serialnumbers_pkey ON datagenerated_serialnumbers USING btree (serialnumberid);
...
CREATE UNIQUE INDEX datagenerated_socialsecuritynumber_pkey ON datagenerated_socialsecuritynumber USING btree (socialsecuritynumberid);
...
CREATE UNIQUE INDEX datagenerated_useridentities_pkey ON datagenerated_useridentities USING btree (useridentitiesid);
...
CREATE UNIQUE INDEX datamodel_datatables_pkey ON datamodel_datatables USING btree (tablename);

CREATE UNIQUE INDEX datamodel_domain_pkey ON datamodel_domain USING btree (domainname);

CREATE UNIQUE INDEX datastructure_address_pkey ON datastructure_address USING btree (completeaddressid);

CREATE UNIQUE INDEX datastructure_bankaccount_pkey ON datastructure_bankaccount USING btree (databuiltbankaccountsid);

CREATE UNIQUE INDEX datastructure_corporations_pkey ON datastructure_corporations USING btree (databuiltcorporationid);

CREATE UNIQUE INDEX datastructure_names_pkey ON datastructure_names USING btree (databuiltnamesid);

CREATE UNIQUE INDEX datastructure_persondemographics_pkey ON datastructure_persondemographics USING btree (persondemographicsid);

CREATE UNIQUE INDEX datastructure_phonenumbers_pkey ON datastructure_phonenumbers USING btree (databuiltphonenumbersid);

CREATE UNIQUE INDEX datastructure_phonenumbersintl_pkey ON datastructure_phonenumbersintl USING btree (databuiltphonenumbersintlid);

CREATE UNIQUE INDEX datastructure_products_pkey ON datastructure_products USING btree (databuiltproductsid);

CREATE UNIQUE INDEX impl_application_pkey ON impl_application USING btree (appguid);

CREATE UNIQUE INDEX impl_codesets_pkey ON impl_codesets USING btree (implcodesetid);

CREATE UNIQUE INDEX impl_codesetscrossmaps_pkey ON impl_codesetscrossmaps USING btree (codesetcrossmapid);

CREATE UNIQUE INDEX impl_codesetstoapplication_pkey ON impl_codesetstoapplication USING btree (codesettoapplicationid);

CREATE UNIQUE INDEX impl_codesetstomsgtype_pkey ON impl_codesetstomsgtype USING btree (codesettomsgtypeid);

CREATE UNIQUE INDEX impl_legalentities_pkey ON impl_legalentities USING btree (legalentityguid);

CREATE UNIQUE INDEX impl_organization_pkey ON impl_organization USING btree (organizationguid);

CREATE UNIQUE INDEX impl_rulesets_pkey ON impl_rulesets USING btree (ruleid);

CREATE UNIQUE INDEX impl_rulesetsdefinitions_pkey ON impl_rulesetsdefinitions USING btree (rulesetdefinitionsid);

CREATE UNIQUE INDEX platform_appsettings_general_pkey ON platform_appsettings_general USING btree (appsettingsid);

CREATE UNIQUE INDEX platform_config_datagen_pkey ON platform_config_datagen USING btree (datagenconfigid);

CREATE UNIQUE INDEX platform_dataattributes_pkey ON platform_dataattributes USING btree (platformdataattributesid);

CREATE UNIQUE INDEX platform_datastructures_pkey ON platform_datastructures USING btree (platformdatastructuresid);

CREATE UNIQUE INDEX platform_datastructurestodataattributes_pkey ON platform_datastructurestodataattributes USING btree (platformdatastructurestodataattributesid);

CREATE UNIQUE INDEX refdata_codeset_pkey ON refdata_codeset USING btree (codesetsid);

CREATE UNIQUE INDEX refdata_countries_pkey ON refdata_countries USING btree (countryid);

CREATE UNIQUE INDEX refdata_datagentypes_pkey ON refdata_datagentypes USING btree (datagentypeid);

CREATE UNIQUE INDEX refdata_devices_devicesid_uindex ON impl_devices USING btree (devicesid);

CREATE UNIQUE INDEX refdata_devices_pk ON impl_devices USING btree (devicesid);

CREATE UNIQUE INDEX refdata_devicetypes_pk ON refdata_devicetypes USING btree (devicetypeid);

CREATE UNIQUE INDEX refdata_industries_pk ON refdata_industries USING btree (industryid);
...
CREATE UNIQUE INDEX refdata_industriestobusiness_pk ON refdata_industriestobusiness USING btree (industrytobusinessid);

CREATE UNIQUE INDEX refdata_industrystd_datatypes_pkey ON refdata_industrystd_datatypes USING btree (datatypestoindustryid);

CREATE UNIQUE INDEX refdata_industrystd_fields_pkey ON refdata_industrystd_fields USING btree (fieldstoindustryid);

CREATE UNIQUE INDEX refdata_industrystd_pkey ON refdata_industrystd USING btree (industrystd);

CREATE UNIQUE INDEX refdata_industrystd_segments_pkey ON refdata_industrystd_segments USING btree (segmenttoindustryid);

CREATE UNIQUE INDEX refdata_operationtype_pkey ON refdata_operationtype USING btree (operationtypeid);

CREATE UNIQUE INDEX refdata_platformparams_pkey ON refdata_platformparams USING btree (platformparamsid);

CREATE UNIQUE INDEX refdata_platformparamstodataattributes_pkey ON refdata_platformparamstodataattributes USING btree (platformparamstodataattributeid);

CREATE UNIQUE INDEX refdata_sensitivityflag_pkey ON refdata_sensitivityflag USING btree (sensitiveflagid);

CREATE UNIQUE INDEX refdata_status_pkey ON refdata_status USING btree (statusid);

CREATE UNIQUE INDEX refdata_terminologystd_pkey ON refdata_terminologystd USING btree (terminologystdid);

CREATE UNIQUE INDEX refdata_timezones_pkey ON refdata_timezones USING btree (timezonevalue);

CREATE UNIQUE INDEX refdata_usstates_pkey ON refdata_usstates USING btree (stateid);

CREATE UNIQUE INDEX refdata_vendor_pkey ON refdata_vendor USING btree (vendorid);

CREATE UNIQUE INDEX terms_codeset_hl7v2_pkey ON terms_codeset_industrystd USING btree (termcodesetid);
