...
CREATE TABLE datamodel_apis (
                                ...
                                createddate timestamp DEFAULT CURRENT_TIMESTAMP,
                                statusid integer DEFAULT 1,
                                apicapabilitiesid integer,
                                PRIMARY KEY (datamodelapiid)
);

CREATE TABLE datamodel_apis_capabilities (
                                             datamodelapiscapabilitiesid serial NOT NULL,
                                             tablename varchar(99),
                                             capability varchar(35),
                                             createddate timestamp DEFAULT CURRENT_TIMESTAMP,
                                             statusid integer DEFAULT 1 NOT NULL,
                                             PRIMARY KEY (datamodelapiscapabilitiesid)
);
...
ALTER TABLE datamodel_apis
    ADD FOREIGN KEY (apicapabilitiesid)
        REFERENCES datamodel_apis_capabilities (datamodelapiscapabilitiesid);
...
ALTER TABLE datamodel_apis_capabilities
    ADD FOREIGN KEY (statusid)
        REFERENCES refdata_status (statusid);
...
CREATE UNIQUE INDEX databasechangeloglock_pkey ON databasechangeloglock USING btree (id);
...
CREATE UNIQUE INDEX datagenerated_custom_pkey ON datagenerated_custom USING btree (datagencustomdid);
...
CREATE UNIQUE INDEX datamodel_apis_capabilities_pk ON datamodel_apis_capabilities USING btree (datamodelapiscapabilitiesid);

CREATE UNIQUE INDEX datamodel_apis_pk ON datamodel_apis USING btree (datamodelapiid);
...
CREATE INDEX datamodelapiscapabilities_index ON datamodel_apis_capabilities USING btree (datamodelapiscapabilitiesid, tablename, capability, createddate, statusid);

CREATE UNIQUE INDEX datastructure_address_pkey ON datastructure_core USING btree (datastructurecoreid);
...
CREATE UNIQUE INDEX impl_codesetscrossmaps_pkey ON impl_codesets_crossmaps USING btree (codesetcrossmapid);
...
CREATE UNIQUE INDEX platform_config_dataattributes_pkey ON platform_config_dataattributes USING btree (datagenconfigid);

CREATE UNIQUE INDEX platform_config_datastructures_pkey ON platform_config_datastructures USING btree (platformdatastructuresid);

CREATE UNIQUE INDEX platform_config_datastructuresdtl_pkey ON platform_config_datastructures_dtl USING btree (platformdatastructurestodataattributesid);
...
CREATE UNIQUE INDEX refdata_devices_devicesid_uindex ON datagenerated_devices USING btree (devicesid);

CREATE UNIQUE INDEX refdata_devices_pk ON datagenerated_devices USING btree (devicesid);
...
CREATE UNIQUE INDEX terms_codeset_industrystd_pkey ON terms_codeset_industrystd USING btree (termcodesetid);
