...
-- sequence usage - datastructurecoreid integer DEFAULT nextval('datastructure_coreid_seq'::regclass) NOT NULL,


-- Create Sequences First
-- Need to create for all serial datatypes
-- Move existing ones already defined
...
CREATE TABLE dataexisting_profession (
                                                ...
                                                statusid integer DEFAULT 1,
                                                professiontypeid integer DEFAULT 1,
                                                createddate timestamp DEFAULT CURRENT_TIMESTAMP,
                                                createduser varchar(20) DEFAULT 'NULL'::character varying,
...
CREATE TABLE impl_professiontypes (
                                             professiontypeid serial NOT NULL,
...
CREATE TABLE impl_regextypes (
                                        implregextypeid serial NOT NULL,
...
CREATE UNIQUE INDEX dataexisting_profession_pkey ON dataexisting_profession USING btree (professionid);
...
CREATE UNIQUE INDEX datagenerated_regexs_pkey ON datagenerated_regexs USING btree (regexid);
...
CREATE UNIQUE INDEX impl_professiontypes_pkey ON impl_professiontypes USING btree (professiontypeid);

CREATE UNIQUE INDEX impl_regextypes_pkey ON impl_regextypes USING btree (implregextypeid);
