...
psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./Platform/1-platform_dataattributes_v2.sql
...
psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./Platform/platform_config_datagen_v2.sql
