...
module.exports = {
        ...
        getDataGenConfig(){
            return `select * from platform_config_dataattributes_generator a,refdata_datagentypes b
            where a.datagentypeid=b.datagentypeid`
        },
    getDataGenConfig_WithDataGenTypeRelationship(){
        return `select * from platform_config_dataattributes_generator a,refdata_datagentypes b, platform_dataattributes c
    ...
    getDataGenConfig_WithoutDataGenTypeRelationship() {
        return `select *
                from platform_config_dataattributes_generator a,
